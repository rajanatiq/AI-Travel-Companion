...
This is the backend service for Wanderlust AI, built with FastAPI, SQLAlchemy, and Python. It manages user authentication, database operations, and integrates with the Google Gemini 3.6 Flash API to generate dynamic, intelligent trip itineraries.

## 🚀 Features
- **FastAPI Framework:** High-performance async API.
- **AI Integration:** Uses Gemini 3.6 Flash to generate verified travel spots concurrently.
